# Generated by Powerlevel10k configuration wizard on 2021-05-01 at 23:27 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awless|terraform|pulumi|terragrunt|tf|ssh'
